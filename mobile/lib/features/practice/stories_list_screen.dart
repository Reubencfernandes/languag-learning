            ...
            children: [
              ...
              Expanded(
                child: Text(
                  ...
                  style: GoogleFonts.nunito(color: kForeground, fontWeight: FontWeight.w900, fontSize: 16),
                ),
              ),
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text('No stories yet', style: GoogleFonts.nunito(color: kForeground, fontWeight: FontWeight.w900, fontSize: 18)),
          const SizedBox(height: 4),
          Text(
            'Generate a bite-size reading lesson.',
            textAlign: TextAlign.center,
            style: GoogleFonts.nunito(color: kMuted, fontWeight: FontWeight.w800, fontSize: 13),
          ),
        ],
      ),
    );
